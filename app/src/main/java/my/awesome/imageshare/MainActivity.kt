...
private lateinit var side: File
  ...
  class MainActivity : AppCompatActivity(), MpesaListener {
      ...
      override fun onCreate(savedInstanceState: Bundle?) {
          ...
          supportActionBar?.title = "Take 3 pics -> SELLit for 30 days "
         ...
         //val callbackResponse=StkCallback("","",1,"")
          ...
          btn_back.setOnClickListener {
              ...
              val fileProvider =
                      FileProvider.getUriForFile(this, "my.awesome.imageshare.fileprovider", photoFil)
          ...
          btn_side.setOnClickListener {
              ...
              val fileProvider =
                      FileProvider.getUriForFile(this, "my.awesome.imageshare.fileprovider", photoF)
